...
\begin{document}
	...
	In this paper, we explain how such a calculator can be designed.\\ Similar projects have been successfully implemented \cite{willforfang}. Our project places its focus more on the complex task of using real and often noisy images.
...
%			(Because our image is inverted, the code uses an erosion function.) %??? fix
	...
	Initially, we have to find the fractions. We find fraction bars, which are contours with the following criteria:
	\begin{itemize}
	...
	\end{itemize}
	We chose these criteria based on experimentation.\\\\
	...
	\begin{itemize}
		\item extract contours above and below the fraction bar (inside the acceptance area) and create a custom fraction object, which references them in the “numerator” or “denominator” property.
