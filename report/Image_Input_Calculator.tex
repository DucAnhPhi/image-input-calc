...
\begin{abstract}
	This paper discusses a program that can solve a variety of handwritten mathematical equations given only an image, using state of the art computer vision and machine learning methods.
	Given a video or a live feed as input the program is able to compute the equation in real time.
	...
	The remaining characters are recognised using an \textit{AlexNet} Artificial Neural Network.
...
This enables a smooth user experience and allows live analysis of an equation.
...
\section{Line Assigning and Ordering}
	...
	\subsection{Preclassification}
	Given the size, shape and positional information along with the order in which the symbols are written 
