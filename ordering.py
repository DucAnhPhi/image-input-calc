...
class LineOrdering:
    ...
    def get_acceptanceRadius(self,symbolList):
        ...
        acceptanceRadius=2*np.median(nnDistanceList)
    ...
    def line_assignement(self, filteredContours, boundingBoxFrame):
        ...
        lineList=[]
        acceptanceRadius=self.get_acceptanceRadius(symbolList)
        ...
        lineIm=cv.cvtColor(boundingBoxFrame,cv.COLOR_GRAY2RGB)
        #for i in range(len(symbolList)):
